...
| LZSA1/2 | `lzsa1`, `lzsa2`; `lzsa*-marty` | Zlib (Emmanuel Marty) | LICENSE-lzsa.md |
...
The LZAN container itself and the `lzan-decoder` / `pucrunch-lzan` 6502 decoders
are original work under the project's MIT license (see `../LICENSE`).
